...
#         SPICY_LIBRARY_DIRS_TOOLCHAIN  Spicy C++ library directories
#         SPICY_LIBRARY_DIRS_RUNTIME    Spicy C++ library directories
#         SPICY_CXX_FLAGS               Spicy C++ flags with include directories
#         SPICY_LD_FLAGS                Spicy C++ linker flags
...
macro (configure)
    ...
    if (NOT spicy_config)
        ...
        run_spicy_config(SPICY_CXX_FLAGS "--cxxflags")
        string(REPLACE " " ";" SPICY_CXX_FLAGS "${SPICY_CXX_FLAGS}")
        message(STATUS "Spicy C++ flags: ${SPICY_CXX_FLAGS}")

        run_spicy_config(SPICY_LD_FLAGS "--ldflags" "--dynamic-loading")
        string(REPLACE " " ";" SPICY_LD_FLAGS "${SPICY_LD_FLAGS}")
        message(STATUS "Spicy linker flags: ${SPICY_LD_FLAGS}")
...
function (run_spicy_config output)
    execute_process(COMMAND "${spicy_config}" "--debug" ${ARGN} OUTPUT_VARIABLE output_
